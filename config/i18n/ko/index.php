...
<li> 업데이트 : 다운로드 후 해당 플러그인 이름 폴더에 업로드하고 압축을 풉니 다.</li>",
 ...
 post_max_size, 다시 시작해야 함)",
    ...
    "common.env.installWithBtTips"   => "서버 PHP 버전은 5.3 이상이 필요하지만 권장 <a target='_blank' href='http://www.bt.cn/?ref=https://anbar.masoud.me'>파고다 패널</a> 의 원 클릭 설정에 익숙하지 않습니다. <br/> 현재 버전",
