...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
 ...
 post_max_size、再起動が必要）",
    ...
    "common.env.installWithBtTips"   => "サーバーのphpバージョンには5.3以上が必要ですが、推奨される<a target='_blank' href='http://www.bt.cn/?ref=https://anbar.masoud.me'>pagodaパネルの</a>ワンクリックセットアップに慣れていません。 <br/>現在のバージョン",
