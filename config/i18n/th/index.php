...
<li> อัปเดต: หลังจากดาวน์โหลดอัปโหลดและเปิดเครื่องรูดไปยังโฟลเดอร์ชื่อปลั๊กอินที่เกี่ยวข้อง</li>",
 ...
 post_max_size ต้องเริ่มต้นใหม่)",
    ...
    "common.env.installWithBtTips"   => "เซิร์ฟเวอร์รุ่น php ต้องใช้ 5.3 และสูงกว่าฉันไม่คุ้นเคยกับการตั้งค่า <a target='_blank' href='http://www.bt.cn/?ref=https://anbar.masoud.me'>แผงเจดีย์ที่</a> แนะนำด้วยคลิกเดียว <br/> รุ่นปัจจุบัน",
