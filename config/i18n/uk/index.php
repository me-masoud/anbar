...
<li> Оновлення: Після завантаження завантажте та розпакуйте у відповідну папку імен плагіна;</li>",
 ...
 post_max_size, потрібно перезапустити)",
    ...
    "common.env.installWithBtTips"   => "Серверна версія PHP вимагає 5.3 і вище. Я не знайомий із налаштуванням рекомендованих <a target='_blank' href='http://www.bt.cn/?ref=https://anbar.masoud.me'>панелей пагоди</a> одним натисканням кнопки. <br/> Поточна версія",
