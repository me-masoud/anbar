...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
 ...
 post_max_size, need to restart)",
    ...
    "common.env.installWithBtTips"   => "The server php version requires 5.3 and above. I am not familiar with the one-click setup of the recommended <a target='_blank' href='http://www.bt.cn/?ref=https://anbar.masoud.me'>pagoda panel</a> . <br/> current version",
