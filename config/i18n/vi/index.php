...
<li> Cập nhật: Sau khi tải xuống, tải lên và giải nén vào thư mục tên trình cắm tương ứng;</li>",
 ...
 post_max_size, cần khởi động lại)",
    ...
    "common.env.installWithBtTips"   => "Phiên bản php máy chủ yêu cầu 5.3 trở lên. Tôi không quen với thiết lập một lần nhấp của <a target='_blank' href='http://www.bt.cn/?ref=https://anbar.masoud.me'>bảng điều khiển chùa được</a> đề xuất. <br/> Phiên bản hiện tại",
