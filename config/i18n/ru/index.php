...
<li> Обновление: после загрузки загрузите и разархивируйте в папку с именем соответствующего плагина;</li>",
 ...
 post_max_size, нужно перезагрузить)",
    ...
    "common.env.installWithBtTips"   => "Версия php сервера требует 5.3 и выше. Я не знаком с настройкой одним щелчком рекомендуемой <a target='_blank' href='http://www.bt.cn/?ref=https://anbar.masoud.me'>панели пагоды</a> . <br/> Текущая версия",
